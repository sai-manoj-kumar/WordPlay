 ...
 *
 * Created on September 18, 2011, 6:25 PM
 */
...
Module* GameModule::Execute() {
    ...
    cout << endl << "Guess the secret word   ";
...
void GameModule::printGuessedWord(string guessedword, vector<char> wrongGuesses) {
    cout << guessedword << "  ";
    cout << "[ Wrong guesses:   ";
